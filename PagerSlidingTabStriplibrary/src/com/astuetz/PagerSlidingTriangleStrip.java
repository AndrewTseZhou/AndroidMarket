...
public class PagerSlidingTriangleStrip extends HorizontalScrollView {
    ...
    private int      tabNormalTextColor   = tabTextColor;
    ...
    private int triangleWidth = 20;//三角形边的宽度
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float y1 = height - indicatorHeight;//第一个点
        float x2 = x1 - triangleWidth / 2;
        float y2 = height;//第二个点
        float x3 = x1 + triangleWidth / 2;
        float y3 = height;//第三个点
